...
Revision ID: 3e6357fabf56
Revises: 
Create Date: 2024-05-27 20:04:37.785375
...
def upgrade():
    ...
    sa.Column('cost_in_credits', sa.String(length=40), nullable=False),
    ...
    sa.Column('MGLT', sa.String(length=10), nullable=False),
